<template>
    <div>
          <div class="background_01 app" id="step1" v-if="isStep1Visible">
            ...
            <b-form @submit.stop.prevent="onSubmit" class="padding_top_30">
              <div class="form width_30">
                ...
                <div class="button-next">
                  ...
                  <b-button @click="nextStep" v-on:click="show = !show" class="btn_01 margin_top_30" type="submit">Suivant
          ...
          <div id="step2" v-if="isStep2Visible">
            <kinesis-container>
              ...
              <b-container>
                ...
                <div class="button-next">
                  <b-button @click="previousStep" class="btn_02 margin_top_30" type="submit">Précedant
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
                    </svg>
                  </b-button>
