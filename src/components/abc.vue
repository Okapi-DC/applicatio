<template>
  <b-container>
    <div class="row">
      <div class="col-md" id="blockRight">
        <div class="d-inline-flex width_30">
          <div class="circle_01 ">1</div>
          <div class="circle_01">2</div>
          <div class="circle_01">3</div>
          <div class="circle_01">4</div>
        </div>

        <div class="d-flex justify-content-between align-items-center mb-3 col-12 col-lg-10 mx-auto">
          <h4 class="">Mon entreprise</h4>
          <p class="fs-4 fw-bold text-secondary">{{ count }}/3</p>
        </div>


        <div>

          <div id="step1" v-if="isStep1Visible">

            <h2 class="padding_top_30">Bienvenue {{ name }}!</h2>
            <p>Vous pouvez toujours changer plus tard !</p>
...
<!--                <b-button to="/" class="btn_01 margin_top_30" type="submit">
                ...
                <b-button @click="nextStep" class="btn_01 margin_top_30" type="submit">Suivant
          ...
          <div id="step2" v-if="isStep2Visible">
            <kinesis-container>
            <h2 class="padding_top_30">Une opportunité pour déterminer votre profil {{ name }}!</h2>
            ...
            <b-container>
              <div class="row text-center padding_top_30">
                <div class="col-sm-2">
                  <kinesis-element :strength="10" transformOrigin="50% 300%" type="translate">
                    <img class="photo-gris" v-bind:src="require('@/assets/LICORNE.svg')" width="120%" alt="service-image">
                  </kinesis-element>
              ...
              <div class="button-next">
                <b-button @click="nextStep" class="btn_02 margin_top_30" type="submit">Suivant
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
                  </svg>
                </b-button>
          ...
          <div id="step3" v-if="isStep3Visible">
            <h2>Nous nourrissons votre potentiel pour révéler vos super pouvoirs</h2>
            <p>Relevez chaque jour un nouveau défi pour développer vos soft skills</p>
            <img class="photo-gris" v-bind:src="require('@/assets/super-power.svg')" width="40%" alt="service-image">
          ...
          <div id="step4" v-if="isStep4Visible">
            <img class="photo-gris" v-bind:src="require('@/assets/ welcome.svg')" width="40%" alt="service-image">
